...
% output paths/names
out_folder='/export/b06/xwang/data/Data_processed'; % Path where to store the processed data
...
% Selected microphone
mic_sels={'Beam_Circular_Array','Beam_Linear_Array'}; % Select here one of the available microphone (e.g., LA6, L1R, LD07, Beam_Circular_Array,Beam_Linear_Array, etc. => Please, see Floorplan)
